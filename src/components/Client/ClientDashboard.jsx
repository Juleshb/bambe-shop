...
const ClientDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`fixed lg:fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0`}>
        <div className="flex flex-col h-full">
          {/* Sidebar Header */}
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 flex-shrink-0">
            <div className="flex items-center">
              <img src={Logo} alt="Logo" className="w-24 mr-3" />
            </div>
            <button
          ...
          <div className="px-6 py-4 border-b border-gray-200 flex-shrink-0">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-[#38B496] bg-opacity-10 rounded-full flex items-center justify-center">
                <Icon icon="mdi:account" className="text-[#38B496] text-xl" />
              </div>
              <div className="ml-3">
          ...
          <nav className="flex-1 px-4 py-6 overflow-y-auto">
              ...
              {navigationItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${
                    activeTab === item.id
                      ? 'bg-[#38B496] bg-opacity-10 text-[#38B496] border border-[#38B496] border-opacity-20'
                      : 'text-gray-700 hover:bg-gray-50 hover:text-[#38B496]'
                  }`}
                >
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-2">
                <Link
                  to="/"
                  className="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-[#38B496] rounded-lg transition-colors"
                >
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/"
                className="flex items-center px-4 py-2 bg-[#38B496] text-white rounded-lg hover:bg-[#F15C26] transition-colors"
              >
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              {/* Welcome Card */}
              <div className="bg-gradient-to-r from-[#38B496] to-[#F15C26] rounded-lg shadow-lg p-6 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-2xl font-bold mb-2">Welcome back, {client?.name}!</h3>
                    <p className="text-white text-opacity-90">Track your property inquiries and stay updated with agent responses.</p>
                  </div>
                  {/* <div className="hidden md:block">
                    <Icon icon="mdi:home-city" className="text-6xl text-white text-opacity-80" />
                  </div> */}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg shadow p-6 border-l-4 border-[#38B496]">
                  <div className="flex items-center">
                    <div className="p-2 bg-[#38B496] bg-opacity-10 rounded-lg">
                      <Icon icon="mdi:message-text" className="w-6 h-6 text-[#38B496]" />
                    </div>
                    <div className="ml-4">
                ...
                <div className="px-6 py-4 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-[#38B496] hover:text-[#F15C26] text-sm font-medium"
                    >
                      View All
                    </button>
                  </div>
                ...
                <div className="divide-y divide-gray-200">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            ...
                            className="text-[#38B496] hover:text-[#F15C26]"
                          >
                  ...
                  {inquiries.length === 0 && (
                    <div className="px-6 py-8 text-center">
                      ...
                      <Link
                        to="/listings"
                        className="inline-flex items-center px-4 py-2 bg-[#38B496] text-white rounded-lg hover:bg-[#F15C26] transition-colors"
                      >
                        <Icon icon="mdi:home" className="mr-2" />
                        Browse Properties
                      </Link>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {inquiry.reply_message && (
                          <div className="mt-3 p-3 bg-[#38B496] bg-opacity-5 rounded-lg border border-[#38B496] border-opacity-20">
                            <p className="text-xs font-medium text-[#38B496] mb-1">Agent Reply:</p>
                            <p className="text-sm text-gray-800">{inquiry.reply_message}</p>
                            <p className="text-xs text-[#38B496] mt-1">Replied: {formatDate(inquiry.replied_at)}</p>
                          </div>
                        )}
                      </div>
                      <button
                        onClick={() => navigate(`/client/inquiry/${inquiry.id}`)}
                        className="ml-4 bg-[#38B496] text-white px-3 py-1 rounded text-sm hover:bg-[#F15C26] transition-colors"
                      >
                        View Details
                      </button>
                    </div>
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-[#38B496] text-white px-4 py-2 rounded-lg hover:bg-[#F15C26] transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-3">
              <button
                type="submit"
                disabled={loading}
                className="bg-[#38B496] text-white px-4 py-2 rounded-lg hover:bg-[#F15C26] transition-colors disabled:opacity-50"
              >
